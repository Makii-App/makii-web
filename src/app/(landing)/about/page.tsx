        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 text-left">
            ...
            <p className="text-lg text-on-surface-variant mb-6">
              Makii no es solo una aplicación de entrega; somos una plataforma SaaS integral de marca blanca diseñada para elevar las operaciones de los restaurantes. Proporcionamos la infraestructura digital para que los chefs puedan concentrarse en lo que mejor saben hacer: crear comida excepcional.
            </p>
