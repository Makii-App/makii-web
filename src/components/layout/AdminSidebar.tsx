    ...
    <aside className="w-64 bg-surface h-screen fixed left-0 top-0 border-r border-surface-container flex flex-col z-50">
      <div className="p-6 border-b border-surface-container">
        <Link href="/" className="text-2xl font-display font-extrabold text-primary tracking-tighter">
          Makii <span className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold block -mt-1">Admin</span>
        </Link>
      </div>
      ...
      <div className="p-4 border-t border-surface-container flex flex-col gap-2">
        <button
          ...
          className="flex items-center justify-center gap-2 w-full bg-secondary-container text-white py-3 rounded-xl font-bold text-sm shadow-md hover:scale-[1.02] active:scale-95 transition-all"
        >
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 rounded-xl font-bold text-sm text-error hover:bg-error/10 transition-all disabled:opacity-60"
        >
